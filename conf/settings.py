...
# Update remote repo after pushing changes.  If True, it will not only push the
# changes to the remote repository, it will also update it, using hg's update
# command.
update_remote_repo = True

# HTML settings
# -------------
# If True, the HTML code generated by Sphinx will be extracted from the .fpickle
# files and added to the Django database.  This also requires the RST files be
